...
cmd({
    ...
    try {
        ...
        let resultsMessage = `🗨️ *Search Results By *🎥  ❮❮  𝗦𝗛𝗔𝗗𝗢𝗪 𝗠𝗢𝗩𝗜𝗘 ✘ 𝗞𝗜𝗟𝗔𝗥  ❯❯  🎥** "${q}":\n\n`;
        searchResults.forEach((result, index) => {
            ...
            resultsMessage += `📽️MOVIE ✘ KILAR  Thumbnail: ${thumbnail}\n\n`;
        });
        ...
        const handleSearchReply = async (replyMek, selectedNumber) => {
            ...
            try {
                ...
                let downloadMessage = `🎥 *${movieDetails.title}*\n\n*💭Available Download Links By *🎥  ❮❮  𝗦𝗛𝗔𝗗𝗢𝗪 𝗠𝗢𝗩𝗜𝗘 ✘ 𝗞𝗜𝗟𝗔𝗥  ❯❯  🎥*:*\n`;
